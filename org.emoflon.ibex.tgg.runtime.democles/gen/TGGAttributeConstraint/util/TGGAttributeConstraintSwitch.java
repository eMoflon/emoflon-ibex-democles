/**
 */
package TGGAttributeConstraint.util;

import TGGAttributeConstraint.*;
 ...
 * @generated
 */
public class TGGAttributeConstraintSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static TGGAttributeConstraintPackage modelPackage;
	 ...
	 * @generated
	 */
	public TGGAttributeConstraintSwitch() {
		if (modelPackage == null) {
			modelPackage = TGGAttributeConstraintPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TGGAttributeConstraintPackage.ATTRIBUTE_CONSTRAINT: {
				...
				if (result == null) result = caseConstraint(attributeConstraint);
